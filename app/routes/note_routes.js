...
// create the key value store as defined in the fabric-client/config/default.json 'key-value-store' setting
        Fabric_Client.newDefaultKeyValueStore({
            ...
            if (user_from_store && user_from_store.isEnrolled()) {
                ...
                throw new Error('Failed to get details for '+user);
            }
            ...
            if (query_responses && query_responses.length == 1) {
                ...
                res.send("No response were returned from query");
            }
        }).catch((err) => {
...
// create the key value store as defined in the fabric-client/config/default.json 'key-value-store' setting
        Fabric_Client.newDefaultKeyValueStore({
            ...
            res.send('User not Registred ' + err);
        });
    ...
    app.post('/addTransction', (req, res) => {
...
// create the key value store as defined in the fabric-client/config/default.json 'key-value-store' setting
        Fabric_Client.newDefaultKeyValueStore({
            ...
            if (isProposalGood) {
                ...
                let txPromise = new Promise((resolve, reject) => {
                    ...
                    event_hub.registerTxEvent(transaction_id_string, (tx, code) => {
                        ...
                        console.log(" Transaction response"+code +" tx code "+transaction_id_string);
            ...
            if (results && results[0] && results[0].status === 'SUCCESS') {
                ...
                res.send('Failed to order the transaction. Error code: ' + response.status);
            }
            ...
            res.send('Failed to add new Transction :: ' + err);
        });
